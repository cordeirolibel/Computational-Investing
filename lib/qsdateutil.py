...
def _cache_dates():
    ''' Caches dates '''
    try:
        # filename = os.environ['QS'] + "/lib/data/NYSE_dates.txt"
        filename = os.path.join(os.path.dirname(__file__), 'data/NYSE_dates.txt')
    except KeyError:
        print("Please be sure you have NYSE_dates.txt in the data directory")
